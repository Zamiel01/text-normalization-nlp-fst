...
- Add a small example script that runs normalization over `test/en_sentences.txt` and writes outputs to `result/`.
- Add a Windows PowerShell test runner or a small `README-quickstart.md` with copy-paste commands.

---
Generated by repository analysis. If you'd like changes (more examples, a quickstart script, or a different README tone), tell me which sections to adjust.
